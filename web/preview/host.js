...
export const COMMANDS = {
  ...
  saveView: [LATER, 'web-app-commands'],
  deleteView: [LATER, 'web-app-commands'],
  moveView: [LATER, 'web-app-commands'],
  runView: [LATER, 'web-app-commands'],
  writeViewField: [LATER, 'web-app-commands'],
  loadPager: [ANSWERED],
