...
export const COMMANDS = {
  ...
  copyImagePath: [REFUSED, 'a picture in an embedded document names nothing on the machine reading it'],
  ...
  frontEndReady: [REFUSED, 'it releases the files a native launch was asked for, and a product mounts the document it wants rather than launching this page with a file list. The word is still sent, because the page says it once whatever is under it and never waits for the answer'],
  ...
  setVaultGitAutoSync: [REFUSED, 'an embedded document has no vault registry'],
  ...
  saveView: [REFUSED, 'it has no vault to hold a view'],
  deleteView: [REFUSED, 'it has no vault to hold a view'],
  moveView: [REFUSED, 'it has no vault to hold a view'],
  runView: [REFUSED, 'it has no vault to run a view over'],
  writeViewField: [REFUSED, 'it owns one document and draws no library'],
  loadPager: [ANSWERED],
