...
use leaftext::{
    ...
    document_headings, document_pager_html, drawable_image_extensions, edit_answered_script,
    edit_refused_script, edit_refused_words, edit_unsaved_words, encode_rgba, encode_rgba_paletted,
    error_toast_script, exported_page_css, exported_page_document, exported_page_minimap_script,
    exported_page_stylesheet, exported_picture_url, failure_message, favorites_missing_script,
    ...
    load_favorites, load_recent_files, load_settings, local_image_protocol_path,
