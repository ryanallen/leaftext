...
pub(crate) use state::{installed_config_dir, installed_data_local_dir};
pub mod store;
mod tei;
pub(crate) use tei::*;
mod xml;
...
pub use editing::{
    ...
    task_marker_offsets, BlockSpan, EditableDocument, FileRecord, PackageBuffer, TableCellMap,
    TableComment, TableMap, TableRowMap, TaskEntry,
};
mod encoding;
pub use encoding::{
