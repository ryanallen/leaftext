(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      'errors.settingsUnreadable': 'Your settings file could not be read, so Leaf Text started with its defaults. Your saved choices are still in the file.',
      ...
      'library.vaults.sync.changeRepo': 'Change repo…',
      'library.vaults.sync.changeRepo.current': 'Now pointing at: {url}',
      'library.vaults.sync.changeRepo.help': 'Paste a new address and press Save. This only changes where it points — your files are sent when you Sync, not now.',
      'library.vaults.sync.changeRepo.save': 'Save',
      'library.vaults.sync.changeRepo.cancel': 'Cancel',
      'library.vaults.sync.changeRepo.restore': 'Put back {url}',
      ...
      'library.vaults.sync.done.linked': 'Repository set. Choose Sync to send your files to it.',
    ...
    'zh-CN': {
      ...
      'errors.settingsUnreadable': '无法读取设置文件，Leaf Text 已使用默认设置启动。你保存的选择仍在该文件中。',
      ...
      'library.vaults.sync.changeRepo': '更换仓库…',
      'library.vaults.sync.changeRepo.current': '当前指向：{url}',
      'library.vaults.sync.changeRepo.help': '粘贴新地址并按“保存”。这只更改指向的位置——你的文件将在“同步”时发送，而非现在。',
      'library.vaults.sync.changeRepo.save': '保存',
      'library.vaults.sync.changeRepo.cancel': '取消',
      'library.vaults.sync.changeRepo.restore': '恢复为 {url}',
      ...
      'library.vaults.sync.done.linked': '已设置仓库。请选择“同步”以将文件发送过去。',
