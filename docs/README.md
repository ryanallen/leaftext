...
| [Themes](01-features/06-themes.md) | The thirteen free families (Amaranth, Arabica, Bloodleaf, Fern, Foxglove, Ginger, GitHub, Goldenrod, Halcyon, Ivy, Nightshade, Pippin, Sage) and the six earned in the Grove (Amber, Cobalt, Ink, Verdant, Vermilion, Violet), light/dark/System/Daylight appearance, on-demand Google Fonts, diagram colors, and the semantic token contract. All nineteen are drawn on one page at [leaftext.com/gallery.html](https://leaftext.com/gallery.html) |
