...
2. Pick any `.md`, `.html`, `.xml`, `.json`, `.yaml`, `.txt`, `.ini`, `.eml`, `.docx`, `.docm`, `.xlsx`, `.xlsm`, `.pptx`, `.pptm`, `.odt`, `.ods`, `.odp`, `.epub`, or [source](01-features/01-rendering.md#source-files) file.
...
```mermaid
flowchart LR
    A[Launch Leaftext] --> B[Open a .md, .xml, .json, .yaml, .eml or .docx file]
...
| Drag and drop | Drop a `.md`, `.html`, `.xml`, `.json`, `.yaml`, `.txt`, `.ini`, `.eml`, `.docx`, `.docm`, `.xlsx`, `.xlsm`, `.pptx`, `.pptm`, `.odt`, `.ods`, `.odp`, `.epub`, or [source](01-features/01-rendering.md#source-files) file onto the window |
