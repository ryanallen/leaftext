...
| Site paths   | `just check-site`           | Fail on a file the published pages fetch by a path that has nothing at it, and on a Previous / Next tooltip that stops naming its page |
