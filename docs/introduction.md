...
leaftext is a desktop app for reading local Markdown and [TEI XML](features/markdown-rendering.md#tei-xml-84000-translations) on macOS, Windows, and Linux. Open a file, get a clean rendered view, and keep your place with [tabs](features/navigation.md#tabs), [history](features/navigation.md#history), a [minimap](features/minimap.md), and a searchable [library](features/library.md).
