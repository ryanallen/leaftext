...
- **On leaftext.com and Emptyguru, the source is for reading.** The code view opens there, but its padlock is absent and typing cannot change the site's copy. The reading view's padlock starts shut on every visit and opening it lasts only for that visit.
