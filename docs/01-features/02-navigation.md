...
- Dragging a tab onto the right half of the page opens it beside as well. The tab rides above everything at your hand, and while it is over the half the second page is drawn as a see-through ghost carrying its name, at the share the split will take; carry it back out and the ghost goes and nothing opens. Along the strip itself the tab still reorders, and only past the last tab does it count as the half.
