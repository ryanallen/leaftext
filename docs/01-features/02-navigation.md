...
| [Export the page](#export-the-page) | Save the page you are reading as one continuous PDF, or as a web page with its stylesheet, its pictures and its [minimap](04-minimap.md#on-an-exported-page) in a folder beside it — either way in the theme on screen |
