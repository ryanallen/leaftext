...
Press a reward and it is drawn whole in the card beside the tree — the Growth area it belongs to, its name, what it does, and everything you can do with it. Until you press one, the card shows the first reward from the soil up that you can grow. On a narrow window the card stands over the tree instead.
