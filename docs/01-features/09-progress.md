...
Everything you can grow sits in one tree, on the Grove sheet's **Tree** tab beside **Growth**, so reaching it never means scrolling past the bars. The sheet opens on whichever of the two you last looked at. The tree climbs from a strip of soil up a trunk in nine bands of Grove levels — **Grove 2–7** at the foot, then **Grove 8–13** and so on up to the last, which runs from Grove 50 to the Grove's ceiling — and each band's label sits on the trunk. The trunk fills from the soil to your own Grove level, and your band's label is filled with it. Each reward is a round button with its name under it, standing straight above the reward it grows from: Woad, Lavender and Iridescent skin climb one line. The tree scrolls up and down only, opens with your own band in view, and your seeds stay one number at the top right.
