...
| [Ivy](https://github.com/ryanallen/leaftext/blob/main/themes/ivy.md) | A terminal palette set in monospace throughout — green ink on near-black dark, green-bar paper light | Feather |
