...
| **plan** (`../docs/features/`, `../docs/refactor/`, `../docs/fixes/`, each grouped into subject folders) | **The one this step exists for.** A plan for something that now ships is the most misleading writing in either tree: move the file into the matching subject folder under `../docs/done/`, and move its row out of the live index [`../docs/README.md`](../../../../docs/README.md) into [`../docs/done/README.md`](../../../../docs/done/README.md) under Shipped, saying what shipped and spelled from that file's own folder. A plan half-built gets the built part struck through, not deleted |
