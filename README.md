...
| [Themes](docs/01-features/06-themes.md) | The thirteen families and the six earned ones, appearance, fonts, diagram colors |
...
| [Glossary](docs/GLOSSARY.md) | Every word Leaftext uses for a part of itself |
| [Themes](themes/README.md) | The thirteen free families and the six earned ones, one Markdown file each, with the colors they set and the icon set they wear |
