...
import { run as runEmbedApi } from './check-shell/embed-api.mjs';
...
import { run as runTheWindowDots } from './check-shell/the-window-dots.mjs';
import { run as runTheStartupCard } from './check-shell/the-startup-card.mjs';
