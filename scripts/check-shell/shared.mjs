...
// The page's script assembled the way the binary assembles it, the same script with its comments taken out as a browser downloads it, the top of the checkout, and the one record what crosses a file boundary by assignment rides on.
export { names, record, root, source, strippedSource } from './script.mjs';
