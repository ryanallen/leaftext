...
**Nothing broken and nothing to press is "Done."** That is the whole reply. Not what it cost, not what turned up on the way, not what is clean, not what a check found, not a number. Anything learned goes in the ticket, where it is wanted, and saying it here is asking them to read your working. Same when they ask what to do next: name the one thing, in the words of what they would see go wrong, and stop.
