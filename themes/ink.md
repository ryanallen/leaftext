...
| Role    | Stack |
| ------- | ----- |
| Heading | `"Public Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"` |
| Body    | `"Public Sans", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"` |
| Code    | `"Noto Sans Mono", ui-monospace, SFMono-Regular, Consolas, "Liberation Mono", Menlo, monospace` |
| Google  | `https://fonts.googleapis.com/css2?family=Public+Sans:wght@400;500;600;700&family=Noto+Sans+Mono:wght@400;500;600;700&display=swap` |
...
| editor-code-selection-background        | `#e4e4e4`                   |
...
| markdown-heading-4                      | `#121212`                   |
| markdown-heading-5                      | `#121212`                   |
| markdown-heading-6                      | `#121212`                   |
| markdown-rule                           | `#e0e0e0`                   |
| markdown-link                           | `#6e6e6e`                   |
| markdown-blockquote-border              | `#8f8f8f`                   |
| markdown-blockquote-foreground          | `#444444`                   |
| markdown-alert-note                     | `#6e6e6e`                   |
| markdown-alert-tip                      | `#087a34`                   |
| markdown-alert-important                | `#6e6e6e`                   |
...
| minimap-viewport-border                 | `#6e6e6e`                   |
| minimap-viewport-background             | `rgba(110, 110, 110, 0.14)` |
| navigation-button-hover-background      | `#8c8c8c`                   |
...
| navigation-recent-item-hover-foreground | `#6e6e6e`                   |
| focus-ring                              | `#8f8f8f`                   |
| focus-selection-background              | `#e9e9e9`                   |
...
| syntax-string                           | `#646464`                   |
| syntax-number                           | `#555555`                   |
| syntax-function                         | `#5e5e5e`                   |
| syntax-variable                         | `#222222`                   |
| syntax-type                             | `#5e5e5e`                   |
| syntax-operator                         | `#6e6e6e`                   |
...
| editor-code-selection-background        | `#3a3a3a`                   |
...
| markdown-link                           | `#bbbbbb`                   |
| markdown-blockquote-border              | `#a2a2a2`                   |
| markdown-blockquote-foreground          | `#dadada`                   |
| markdown-alert-note                     | `#bbbbbb`                   |
| markdown-alert-tip                      | `#44cf6e`                   |
| markdown-alert-important                | `#a2a2a2`                   |
...
| minimap-viewport-border                 | `#a2a2a2`                   |
| minimap-viewport-background             | `rgba(162, 162, 162, 0.14)` |
| navigation-button-hover-background      | `#bbbbbb`                   |
...
| navigation-recent-item-hover-foreground | `#bbbbbb`                   |
| focus-ring                              | `#a2a2a2`                   |
| focus-selection-background              | `#343434`                   |
| focus-selection-foreground              | `#ffffff`                   |
| syntax-background                       | `#181818`                   |
| syntax-foreground                       | `#dadada`                   |
| syntax-comment                          | `#8c8c8c`                   |
| syntax-keyword                          | `#d0d0d0`                   |
| syntax-string                           | `#d9d9d9`                   |
| syntax-number                           | `#989898`                   |
| syntax-function                         | `#bbbbbb`                   |
| syntax-variable                         | `#dadada`                   |
| syntax-type                             | `#bbbbbb`                   |
| syntax-operator                         | `#d0d0d0`                   |
